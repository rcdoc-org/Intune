...
$ScriptVersion = "1"
$BlockedAppsListUrl = "https://github.com/rcdoc-org/Intune/blob/main/Autopilot/AppsToRemove.txt"
...
function Disable-ChatAutoInstall {
    ...
    function Write-LogEntry {
        ...
        $LogFilePath = Join-Path -Path $env:SystemRoot -ChildPath $($env:ProgramData)\Intune\$FileName")
